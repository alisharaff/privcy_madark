...
This information is used only for authentication and account access and is not used for any other purpose.

2. Usage & Technical Information

We may automatically collect non-personal technical information, including:
...
This data is collected for security, analytics, and app improvement purposes and does not directly identify users.
...
Third-party analytics tools (such as Meta / Facebook App Events) to understand app installs, launches, and user engagement

The Advertising ID does not personally identify users and can be reset or disabled from the device settings.
...
Provide access to courses, exams, and educational content
...
Madarek may integrate third-party services such as:
...
Data may only be shared when required:
